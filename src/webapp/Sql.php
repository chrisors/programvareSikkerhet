...
class Sql
{
    ...
    static function up()
    {
        $q1 = "CREATE TABLE users (id INTEGER PRIMARY KEY, user VARCHAR(50), pass VARCHAR(50), email varchar(50) default null, first_name varchar(50), last_name varchar(50), phone varchar (8), company varchar(50), isadmin INTEGER, failed_logins INTEGER, first_failed_login INTEGER);";
        $q6 = "CREATE TABLE patent (patentId INTEGER PRIMARY KEY AUTOINCREMENT, company TEXT NOT NULL, title TEXT NOT NULL, file TEXT, description TEXT NOT NULL, date TEXT NOT NULL, FOREIGN KEY(patentId) REFERENCES users(company));";
    ...
    static function insertDummyUsers()
    {
        ...
        $hash2 = Hash::make('nr1ManUtd!');
        $hash3 = Hash::make('nr2Looserpool!');
